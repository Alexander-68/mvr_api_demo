(function () {
  ...
  function ensureStylesLoaded() {
    ...
    style.textContent = [
      ...
      ".info-grid article{border:1px solid #d8dee5;border-radius:8px;padding:12px;background:#fff}dl{display:grid;grid-template-columns:max-content minmax(0,1fr);gap:5px 6px;margin:0}dt{max-width:118px;color:#657282;font-weight:800;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}dt::after{content:':'}dd{margin:0;overflow-wrap:anywhere}",
      ".muted{color:#657282}",
