...
### Live Mode shortcut Keys (reviewed 260519\)
...
* Middle mouse button (mouse wheel click) or '5': hold to show the color picker — displays the RGB (0..255) value of the pixel under the mouse cursor; hides on release.
...
* Back: Ctrl+ESC, Ctrl+’b’, Ctrl+NUMPAD\_1.  
* Back: gesture: quick swipe from the left or right edge of the screen (added on 250903).  
* Home (back to the MVR app, which is the HOME app): Ctrl+’h’, Ctrl+’\~’, Ctrl+NUMPAD\_7.
